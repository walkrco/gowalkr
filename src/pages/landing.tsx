          ...
          <div className="space-y-16">
            ...
            <div className="space-y-8">
              <h1 className="text-6xl md:text-8xl lg:text-9xl font-tungsten text-white leading-none tracking-tight">
                FASTER.<br/>
                STRONGER.<br/>
                <span className="text-transparent bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text animate-pulse">
                  SMARTER.
                </span>
              </h1>
              ...
              <Button 
                ...
                size="default"
                className="bg-gradient-to-r from-orange-500 to-orange-600 text-white hover:from-orange-600 hover:to-orange-700 px-8 py-3 text-base rounded-full transition-all duration-300" 
                style={{
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-3 gap-12">
              ...
              <div className="text-center space-y-6 group">
                <div className="relative">
                  <div className="w-24 h-24 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-6 transition-all duration-500 group-hover:scale-110 group-hover:shadow-2xl">
      ...
      <section ref={statsRef} className="py-32 bg-gray-800">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-16 max-w-6xl mx-auto text-center">
            ...
            <div className="space-y-6 group">
              <div className="text-8xl font-tungsten text-transparent bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text transition-all duration-500 group-hover:scale-110">5-30</div>
      ...
      <section className="bg-gray-400">
        <div className="grid md:grid-cols-2">
          ...
          <div className="bg-gray-800 py-32 px-6 md:px-12 min-h-screen">
            ...
            {/* Step 1: Generate */}
            <div className="space-y-8">
              <div className="w-1 h-16 bg-gradient-to-b from-orange-500 to-orange-600"></div>
              <div>
      ...
      <section className="py-40 bg-white text-black relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="max-w-5xl mx-auto space-y-16">
            <h2 className="text-7xl md:text-9xl font-tungsten text-black leading-none tracking-tight">
              READY TO<br/>
